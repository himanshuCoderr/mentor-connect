...
function MentorProfileCreation() {
  ...
  function mentorApprovalRequest(e) {
    ...
    const user = auth.currentUser; // ya useAuth() se user lo agar context hai
    const uid = user.uid;

    console.log(mentorApprovalData);

    // Firestore me data save karo
    setDoc(doc(db, "mentorRequest", uid), {
      ...mentorApprovalData,
      isApproved: false,
      createdAt: new Date(),
    })
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 font-sans">
      ...
      <section className="bg-gradient-to-br from-gray-800 via-gray-900 to-blue-900 pt-16 sm:pt-20 md:pt-24 pb-12 sm:pb-16 md:pb-20 min-h-screen flex items-center">
        <div className="container lg:mt-6 mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="bg-gray-700 px-4 sm:px-6 md:px-8 py-4 sm:py-6 border-b border-gray-600">
              ...
              <p className="text-gray-400 mt-1 text-sm sm:text-base">
                Complete the steps below to become a mentor.
              </p>
                ...
                {currentStep === 1 && (
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-xs sm:text-sm text-gray-400 font-medium uppercase tracking-wide mb-1 sm:mb-2"
                      >
                        Name
                      </label>
                      <input
                        type="text"
                        id="name"
                        value={userType === "mentor" && userName}
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        id="experience"
                        value={mentorApprovalData.experience}
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:outline-none focus:border-yellow-400 transition duration-300 text-sm sm:text-base"
                        onChange={(e) =>
                          setMentorApprovalData({
                            ...mentorApprovalData,
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        id="skills"
                        value={mentorApprovalData.skills.join(", ")}
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:outline-none focus:border-yellow-400 transition duration-300 text-sm sm:text-base"
                        onChange={(e) =>
                          setMentorApprovalData({
                            ...mentorApprovalData,
                            skills: e.target.value
                              ...
                              : [], // Empty input ke liye empty array
                          })
                        }
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        id="pricing"
                        value={mentorApprovalData.pricing}
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:outline-none focus:border-yellow-400 transition duration-300 text-sm sm:text-base"
                        onChange={(e) =>
                          setMentorApprovalData({
                            ...mentorApprovalData,
                ...
                {currentStep === 2 && (
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        id="teachingStyle"
                        value={mentorApprovalData.teachingStyle}
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:outline-none focus:border-yellow-400 transition duration-300 text-sm sm:text-base"
                        onChange={(e) =>
                          setMentorApprovalData({
                            ...mentorApprovalData,
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={mentorApprovalData.timeSlots}
                        onChange={(e) =>
                          setMentorApprovalData({
                            ...mentorApprovalData,
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        id="languages"
                        value={mentorApprovalData.languages.join(", ")}
                        onChange={(e) =>
                          setMentorApprovalData({
                            ...mentorApprovalData,
                ...
                {currentStep === 3 && (
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <p className="text-gray-400 text-sm sm:text-base">
                      Please review your details before submitting. You can go
                    ...
                    <div className="bg-gray-700 p-4 sm:p-6 rounded-lg space-y-3 sm:space-y-4">
                      <div>
                        ...
                        <p className="text-gray-200 text-sm sm:text-base">
                          Experience: {mentorApprovalData.experience}
                        </p>
                        <p className="text-gray-200 text-sm sm:text-base">
                          Skills: {mentorApprovalData.skills.join(", ")}
                        </p>
                        <p className="text-gray-200 text-sm sm:text-base">
                          Pricing: {mentorApprovalData.pricing}
                        </p>
                        <button
                          onClick={() => setCurrentStep(1)}
                      ...
                      <div>
                        ...
                        <p className="text-gray-200 text-sm sm:text-base">
                          Teaching Style: {mentorApprovalData.teachingStyle}
                        </p>
                        <p className="text-gray-200 text-sm sm:text-base">
                          Available Time Slots: {mentorApprovalData.timeSlots}
                        </p>
                        <p className="text-gray-200 text-sm sm:text-base">
                          Skills: {mentorApprovalData.languages.join(", ")}
                        </p>
                        <button
                    ...
                    <p className="text-gray-400 text-xs sm:text-sm">
                      Your profile will be reviewed for approval. Only genuine
                      mentors will be approved.
                    </p>
